...
public class RetriveMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        ValueEventListener listener=databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                mMap.addMarker(new MarkerOptions().position(location).title("bhjbuib"));
    ...
    private String getCompleteAddress(double Latitude,double Longtitute){
        String address = "";
        Geocoder geocoder=new Geocoder(RetriveMapsActivity.this, Locale.getDefault());
         try {
             List<Address> addresses=geocoder.getFromLocation(Latitude,Longtitute,1);
             if(address!=null){
